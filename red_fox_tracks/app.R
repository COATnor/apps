...
server <- function(input, output) {
  output$figure <- renderLeaflet({
    ...
    # fox names
    deviceIDs <- c("92158", "92156", "92162", "92160", "92638", "92642", "92636", "92166", "92161", "92637", "92635", "92639", "92647", "92644")


    foxnames <- data.frame(
      name = c("Thorsen", "Kaptein Jan", "Mari", "Uhcci Biret", "Murphy", "Geir", "Kate", "Pedersen", "Wilhelmina", "Willem", "Tina", "Simmon", "Sarre", "Clara"),
      deviceID = c("92158", "92156", "92162", "92160", "92638", "92642", "92636", "92166", "92161", "92637", "92635", "92639", "92647", "92644"),
      colour = c("yellow", "lime", "blue", "cyan", "orange", "cyan", "yellow", "magenta", "orange", "cyan", "magenta", "lime", "blue", "red"),
      deployment = c(
        ...
        "2024-10-26T02:00:00", "2024-11-01T01:00:00", "2024-11-05T01:00:00", "2024-11-07T21:00:00"
      ),
      radius = c(4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4),
      radiuslast = c(12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12)
    )
